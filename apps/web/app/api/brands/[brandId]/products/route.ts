...
import { listBrandProductsAsync } from "../../../../../lib/growth-workflow-data";
...
export async function GET(_request: Request, { params }: ProductsRouteProps) {
  ...
  return createApiResponse({
    brandId,
    products: await listBrandProductsAsync(brandId)
  });
}
